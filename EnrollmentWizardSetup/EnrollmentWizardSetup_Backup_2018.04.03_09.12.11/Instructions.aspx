<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Instructions.aspx.cs" Inherits="EnrollmentWizardSetup.Instructions" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="Section">
            <asp:Label ID="lblPageTitle" runat="server" Text="Instuctions Page Setup" CssClass="FontLarge"
        ...
        <div class="Section">
            <asp:RadioButtonList ID="rblItem" runat="server" CssClass="FontSmall10" Font-Bold="True"
                ...
                <asp:ListItem Selected="True" Value="5">Message</asp:ListItem>
            </asp:RadioButtonList>
        </div>
