<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Wellnessplan.aspx.cs" Inherits="EnrollmentWizardSetup.Wellnessplan" %>
...
<uc1:SetupTabStrip ID="SetupTabStrip1" runat="server" />
    <div class="Section">
        <asp:Label ID="lblPageTitle" runat="server" Text="Wellness plan popup Text " CssClass="FontLarge"
    ...
    <div class="Section">
        <asp:RadioButtonList ID="rblItem" runat="server" CssClass="FontSmall10" Font-Bold="True"
            ...
            <asp:ListItem Selected="True" Value="34">Participant</asp:ListItem>
            <asp:ListItem Value="35">Non-Participant</asp:ListItem>
        </asp:RadioButtonList>
    </div>
