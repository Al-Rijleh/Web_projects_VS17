...
{
    public partial class Summary_Authorization : System.Web.UI.Page
    {
        string session_id = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                SetupTabStrip1.SetTabIndex(6);
                SetAccountName();
                ViewState["rbAccount"] = rblAccounts.Items[1].Text;
                GetText();
                setPrePostTax();
                DataTable tbl = Data.FinalizePageItems();
                rblItem.Items.Clear();
