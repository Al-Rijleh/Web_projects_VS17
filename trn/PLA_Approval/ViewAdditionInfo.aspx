			...
			<TABLE class="smallsize" id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px"
				...
				<TR>
					<TD vAlign="top" height="60%">
						<asp:TextBox id="txtAdditionInformation" runat="server" Width="100%" CssClass="smallsize" Height="95%"
							TextMode="MultiLine" ReadOnly="True" BackColor="Gainsboro" BorderColor="White" BorderStyle="None"></asp:TextBox>
					</TD>
				</TR>
				<TR>
					<TD height="1%">&nbsp;</TD>
