...
<body>
    <form id="form1" runat="server">
        ...
        <div class="Section">
            &nbsp;<asp:Label ID="lblPageName" runat="server" Text="Page Name:" CssClass="FontSmall" Width="120px" Font-Bold="True"></asp:Label>
            <asp:TextBox ID="txtPageName" runat="server" Width="497px"></asp:TextBox>
            <asp:Button ID="SaveTitle" runat="server" Text="Save" Width="75px" OnClick="SaveTitle_Click" />
        </div>
        <div class="Section" style="padding-top: 10px">
            <asp:Label ID="lblResponseTypeOE" runat="server" Text="ResponseType OE" CssClass="FontSmall" Font-Bold="True" Style="margin-bottom: 5px" Width="120px"></asp:Label>
            &nbsp;<asp:DropDownList ID="ddlResponseTypeOE" runat="server" Width="500px"></asp:DropDownList>
            <asp:Button ID="btnSaveResponseTypeOE" runat="server" Text="Save" Width="75px" OnClick="btnSaveResponseTypeOE_Click" />
        </div>

        <div class="Section" style="padding-top: 10px">
            <asp:Label ID="lblResponseTypeNH" runat="server" Text="ResponseType NH" CssClass="FontSmall" Font-Bold="True" Style="margin-bottom: 5px" Width="120px"></asp:Label>
            &nbsp;<asp:DropDownList ID="ddlResponseType" runat="server" Width="500px"></asp:DropDownList>
            <asp:Button ID="btnSaveResponseType" runat="server" Text="Save" Width="75px" OnClick="btnSaveResponseType_Click" />
        </div>

        <div class="Section" style="padding-top: 10px">
            <asp:Label ID="lblResponseTypeLE" runat="server" Text="ResponseType LE" CssClass="FontSmall" Font-Bold="True" Style="margin-bottom: 5px" Width="120px"></asp:Label>
            &nbsp;<asp:DropDownList ID="ddlResponseTypeLE" runat="server" Width="500px"></asp:DropDownList>
            <asp:Button ID="btnSaveResponseTypeLE" runat="server" Text="Save" Width="75px" OnClick="btnSaveResponseTypeLE_Click" />
        </div>
        ...
        <div id="Div1" class="Section" runat="server" style="text-align: center; border-top: black 1px solid; border-bottom: black 1px solid;">
        ...
        <div id="dvView" class="Section" runat="server">
            ...
            <div class="Row">
                ...
                <div class="RightRegion">
                    &nbsp;<asp:Label ID="lblDescription" runat="server" CssClass="FontSmall"></asp:Label>
                </div>
            </div>
            <div class="Row">
                <div class="LeftRegion">
            ...
            <div class="Row" style="padding-top: 5px">
                ...
                <div class="RightRegion">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="textDescription"
                        CssClass="FontSmall" Display="Dynamic" ErrorMessage="Required Info"></asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="Row">
