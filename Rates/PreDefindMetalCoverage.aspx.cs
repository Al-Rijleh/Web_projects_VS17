...
namespace Rates
{
    public partial class PreDefindMetalCoverage : System.Web.UI.Page
    {
        ...
        private void DrawGrid()
        {
            ...
            lblCategory.Text = ddlPlansList.SelectedItem.Text.Substring(ddlPlansList.SelectedItem.Text.Length - 16).Replace("(INS-MED - ", "").Replace(")", "");
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            if (Request.Params["back"].Equals("3"))
            {
            ...
            if (!string.IsNullOrEmpty(Request.Params["back"]) && Request.Params["back"].Equals("2"))
            {
                ...
                Response.Redirect(SQLStatic.Sessions.GetSessionValue(session_id, "BACKTOCVRG"), true);
                ...
                //string strURL = "/web_projects/Coverages/ERCoverages/EditMainCiveragePage.aspx?IndexID=" + Request.Params["cvrgid"] + "&userID=" + Request.Params["userID"];
                //Response.Redirect(strURL, true);
                //lblScript.Text = "<script type='text/javascript'>window.open(" + strURL + ", 'MyEnroll_users_data_display_and_edit_content_frame');</script>";
                return;
            }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (Request.Params["back"].Equals("3"))
            {
                SQLStatic.Sessions.SetSessionValue(session_id, "effectivedate", txtEffectiveDates.SelectedDate.Value.ToShortDateString());
                SQLStatic.Sessions.SetSessionValue(session_id, "catplan", lblCategory.Text.Trim());
                SQLStatic.Sessions.SetSessionValue(session_id, "LongDesc", ddlPlansList.SelectedItem.Text);
                SQLStatic.Sessions.SetSessionValue(session_id, "met_id", ddlPlansList.SelectedItem.Value);
