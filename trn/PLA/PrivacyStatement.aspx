...
<%@ Page Language="c#" Codebehind="PrivacyStatement.aspx.cs" AutoEventWireup="false"
    Inherits="Training_Source.PrivacyStatement" %>
                        ...
                        <tr>
                            <td valign="top">
                                <table class="fontsmall" id="Table3" cellspacing="0" cellpadding="0" width="100%"
                                    border="0">
                                    <tr>
                                        <td height="1%" style="width: 793px">
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td height="1%" style="width: 793px" align="center">
                                            <asp:Label ID="Label20" runat="server" CssClass="smallfont" Font-Bold="True">Privacy Act Statement</asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td align="center" height="1%" style="width: 793px">
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="border-bottom: silver thin; width: 793px; border-top-style: none; border-right-style: none;
                                            border-left-style: none;" valign="top" align="left" height="250">
                                            <div style="overflow: auto; width: 780px; height: 240px; text-align: left; border-bottom: silver thin solid;"
                                                align="left">
                                                <asp:Label ID="lbl_fldPLAPrivacyNotice" runat="server" CssClass="smallfont">Star Functionality Field</asp:Label></div>
                                        </td>
                                    </tr>
                                    <tr>
