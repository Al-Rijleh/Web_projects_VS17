...
{
    public partial class DependentInfo : System.Web.UI.Page
    {
        string session_id = "";
        ...
        {
            rblDisableDep.Items.FindByValue(Data.Get_er_property_accnt(ViewState["Selected_Account_Number"].ToString(), "321", "0", "3")).Selected = true;
        ...
        protected void cblAccounts_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cblAccounts.SelectedValue.Equals("1"))
            {
                ...
                string strWarning = BASUSA.MiscTidBit.JSAlert(Welcome.stAlertMessage);
        ...
        protected void btnDisableStudentAll_Click(object sender, EventArgs e)
        {
            Data.Save_er_property(ViewState["Selected_Account_Number"].ToString(), "321", rblDisableDep.SelectedValue, ViewState["User_Name"].ToString(), "2", null);
            Bas_Utility.Misc.AlertSaved(Page);
        }
    }
}
