...
<div class='fontsmall' style='width=599px;float:left'>
 ...
 <div class='fontsmall' style='width=120px;float:left;visibility:hidden'><input type='text' id='txteerate?' size='10'onkeypress='return isNumberKey(event)' onblur='calc(this)' value='&&3'></div>
       ...
       // <input id="Checkbox1" checked="checked" type="checkbox" />
        protected string strCvrg = "<br /><input type='checkbox' id='Cb#' onclick='cb(this)' /><span class='fontsmall10' style='margin-bottom:5px;color:Black' >Check here if you need us to send COBRA continuants open enrollment information about this plan</span>&nbsp;";
        protected string strCvrgChecked = "<br /><input type='checkbox' checked='checked' id='Cb#' onclick='cb(this)' /><span class='fontsmall10' style='margin-bottom:5px;color:Black' >Check here if you need us to send COBRA continuants open enrollment information about this plan</span>&nbsp;";
