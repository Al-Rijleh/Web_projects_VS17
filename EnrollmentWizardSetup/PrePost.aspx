<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrePost.aspx.cs" Inherits="EnrollmentWizardSetup.PrePost" %>
...
<body>
    <form id="form1" runat="server">
        ...
        &nbsp;
        <div class="Section">
            <asp:Label ID="lblPageTitle" runat="server" Text="Pre/Post Page" CssClass="FontLarge"
        ...
        <div class="Section">
            <asp:RadioButtonList ID="rblItem" runat="server" CssClass="FontSmall10" Font-Bold="True"
                ...
                <asp:ListItem Selected="True" Value="20">Message</asp:ListItem>
            </asp:RadioButtonList>
        </div>
