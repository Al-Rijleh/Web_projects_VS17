...
namespace PLA_Source
{
	...
	public class BudgetDetail : System.Web.UI.Page
	{
		...
		private void DrawGrid()
		{
            ...
            DataTable tblCP = Training_Source.TrainingClass.CPBudgetDetail(Request.Params["ee"], ddlBudgetYear.SelectedItem.Text);
        ...
        protected void dgCPDetail_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            DataTable tbl = (DataTable)dgCPDetail.DataSource;
            if (tbl == null)
                tbl = GetGridTable();
            try
            {
                if (tbl.Rows[e.Item.ItemIndex]["budget_categories_id"].ToString() == "1000")
                {
                    e.Item.BackColor = System.Drawing.ColorTranslator.FromHtml("#0066CC");
                    e.Item.ForeColor = System.Drawing.Color.White;
                    e.Item.Font.Bold = true;
