...
namespace Documents
{
    public class Data
    {
        ...
        public static string SaveDocument(string session_id, string strHeaderID, string strEmployeeNumber, string strName, string strDescription,
            string strType, string strUserName)
        {
            ...
            al.Add(SQLStatic.StoredProcedure.OneParamerer("heaer_record_id_", "in", "varchar2", strHeaderID));
            al.Add(SQLStatic.StoredProcedure.OneParamerer("employee_number_", "in", "varchar2", strEmployeeNumber));
            al.Add(SQLStatic.StoredProcedure.OneParamerer("document_name_", "in", "varchar2", strName));
            al.Add(SQLStatic.StoredProcedure.OneParamerer("Description_", "in", "varchar2", strDescription));
            al.Add(SQLStatic.StoredProcedure.OneParamerer("type_of_submission_", "in", "varchar2", strType));
            al.Add(SQLStatic.StoredProcedure.OneParamerer("user_name_", "in", "varchar2", strUserName));
            al.Add(SQLStatic.StoredProcedure.OneParamerer("new_Doc_id", "out", "varchar2", null));
            al = SQLStatic.StoredProcedure.ExecuteNonQueryProcedure("pkg_training.savedocument", al);
            return al[0].ToString().Replace("new_Doc_id=", "");
        }

        public static void SaveDocument(string session_id, string strRecordID)
        {
        ...
        public static DataTable GetDocuments(string strHeaderID)
        {
            ArrayList al = new ArrayList(2);
            al.Add(SQLStatic.StoredProcedure.OneParamerer("heaer_record_id_", "in", "varchar2", strHeaderID));
            al.Add(SQLStatic.StoredProcedure.OneParamerer("retresulr_", "out", "cursor", null));
            return SQLStatic.StoredProcedure.ExecuteTableProcedure("pkg_training.getdocuments", al);
        }

        public static DataTable GetDocumentImage(string strR_LogID)
        {
            ArrayList al = new ArrayList(2);
            al.Add(SQLStatic.StoredProcedure.OneParamerer("r_log_id_", "in", "varchar2", strR_LogID));
            al.Add(SQLStatic.StoredProcedure.OneParamerer("retResult_", "out", "cursor", null));
            return SQLStatic.StoredProcedure.ExecuteTableProcedure("pkg_training.GetDocumentImage", al);
        }

        public static DataTable GetDocumentNameDescription(string strHeaderID, string strRecordID)
        {
            ArrayList al = new ArrayList(3);
            al.Add(SQLStatic.StoredProcedure.OneParamerer("header_id_", "in", "varchar2", strHeaderID));
            al.Add(SQLStatic.StoredProcedure.OneParamerer("record_id_", "in", "varchar2", strRecordID));
            al.Add(SQLStatic.StoredProcedure.OneParamerer("retResult_", "out", "cursor", null));
            return SQLStatic.StoredProcedure.ExecuteTableProcedure("pkg_training.GetDocumentNameDesccription", al);
        }
    }
}
