...
{
	/// <summary>
	/// Summary description for PLA_Step1.
	/// </summary>
	public class PrivacyStatement : System.Web.UI.Page
	{
		...
		private void optAgree_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			if (optAgree.SelectedIndex==0)
			{
                ...
                Response.Redirect("/web_projects/pTemplate/routing/Default.aspx?URL_=/web_projects/DemographicsPage/Default.aspx?SkipCheck=YES");
		}
	}
}
