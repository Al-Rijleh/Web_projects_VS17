<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreDefindMetalCoverage.aspx.cs"
    Inherits="Automated_Rate_Update.PreDefindMetalCoverage"  %>
...
<body>
    ...
    <div class="FullPageMenu" runat="server" id="dvSelectReport">
        ...
        <table>
          <tr>
            <td>
            <asp:CheckBox ID="cbOe" runat="server" Text=""
                Visible="true" />   
            </td>
            <td>
            COBRA continuants should have the right to participate in open enrollment. Check here if you want CCS to send COBRA continuants an enrollment form to make open enrollment elections.
            </td>
          </tr>
        </table>
    ...
    <div class="FullRowMenu margintop20 marginbottom10" id="dvRatelbl" runat="server"
        ...
        <asp:Label ID="Label1" runat="server" Text="VS13"></asp:Label>
    </div>
    <%--Rates List--%>
