	...
	<body MS_POSITIONING="GridLayout" onload="window.focus()">
		<form id="Form1" method="post" runat="server">
			<TABLE class="fontsmall" id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px"
				...
				<TR>
					<TD style="HEIGHT: 14px"><asp:label id="Label1" runat="server" Font-Bold="True">Budget Year</asp:label><asp:dropdownlist id="ddlBudgetYear" runat="server" Width="60px" CssClass="fontsmall" AutoPostBack="True"></asp:dropdownlist><asp:label id="lblBalance" runat="server" Visible="False"></asp:label></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD align="center" style="height: 112px"><asp:datagrid id="dgBudgetDetail" runat="server" Width="75%" CssClass="fontsmall" CellPadding="5"
				...
				<TR>
					<TD align="center"><asp:datagrid id="dgCPDetail" runat="server" Width="75%" CssClass="fontsmall" CellPadding="5"
							BorderWidth="1px" BorderColor="Black" AutoGenerateColumns="False" OnItemDataBound="dgCPDetail_ItemDataBound">
                        <Columns>
