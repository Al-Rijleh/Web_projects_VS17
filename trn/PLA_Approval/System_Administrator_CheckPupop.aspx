<%@ Page language="c#" Codebehind="System_Administrator_CheckPupop.aspx.cs" AutoEventWireup="false" Inherits="PLA_Approval.System_Administrator_CheckPupop" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PopupChecker</title>
	</HEAD>
	<BODY onload="IsPopupBlocker()">
		...
		function IsPopupBlocker() {
			...
			WindowOpen.close();	
			window.location.href="System_Administrator.aspx?SkipCheck=YES"	
			} 
			catch(e){ 
