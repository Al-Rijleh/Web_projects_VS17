<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="BenefitStatement.Default" %>
...
<body style="font-size: 12pt; background-color: white; padding-right: 0px; padding-left: 0px;
    padding-bottom: 0px; margin: 0px; padding-top: 0px">
    <form id="form1" runat="server">
    <table border="0" cellpadding="0" cellspacing="0" style="width: 770px" class="fontsmall">
        <tr>
    ...
    <div class="FullPage" style="float: left">
        <div class="FullPage" id="dvAll" runat="server" style="float: left; margin-left: 10px;">
            <div id="Div5" class="InputRowTitle" style="width: 690px;">
                <div style="float: right">
                    <asp:LinkButton ID="lnbtnGoToPrint" runat="server" CssClass="FontSmall10" Font-Bold="True"
                        OnClick="lnbtnGoToPrint_Click" Visible="False">Go To Print Page</asp:LinkButton>
                </div>
                <div id="dvprint" runat="server" style="float: right">
                    <asp:HyperLink ID="hlPrintIcon" runat="server" CssClass="FontSmall10" Font-Bold="True"
                        NavigateUrl="Javascript:window.print()" ImageUrl="~/Img/printer.png" ToolTip="Print"
                        BorderWidth="0px">Print</asp:HyperLink>
            ...
            <div id="dvTitle" class="InputRowTitle" style="width: 725px">
                <asp:Label ID="lblInstuction" runat="server" CssClass="FontSmall">The following summarizes your group benefit plan enrollment for the "Plan Year" identified above. If you have any questions about this information, you may email or call us at the Contact Information listed above. </asp:Label>
                <asp:Label ID="lblExtraText" runat="server" CssClass="FontSmall"></asp:Label>
            </div>
            <div id="Div4" class="InputRowTitle" style="width: 700px">
      ...
      <b><u><span style="font-size:12.0pt;color:red"><br >****Your plan costs for medical/vision, and/or dental are not displayed below. Please refer to the "Plan Cost" document in the Reference Library.****</span></u> </b>
            ...
            <div class="Datablank10" style="height: 25px; width: 690px;">
                &nbsp;
            </div>
            ...
            <div id="dvYourElection" class="InputRowTitle" runat="server" style="width: 700px">
                <asp:Label ID="lblCostBase" runat="server" CssClass="FontSmall">
      Your monthly cost is based on a 12 month pay schedule.  It will be different for those paid on a 10 month pay schedule.
            ...
            <div id="dvTax" class="NewDataColumn" runat="server" visible="false" style="width: 725px">
                <div style="float: left; vertical-align: bottom; width: 690px; height: 27px;" class="dvYourElection">
                    <br />
            ...
            <div class="InputRowTitle" style="width: 690px" id="Div6" runat="server">
                <asp:GridView ID="gvSummary" runat="server" AutoGenerateColumns="False" CssClass="FontSmall"
                    GridLines="None" Width="690px" OnRowCreated="gvSummary_RowCreated1" ShowFooter="True">
                    <Columns>
            ...
            <div class="InputRowTitle" style="width: 690px" id="dvSummary" runat="server">
                <asp:GridView ID="gvSummaryOld" runat="server" AutoGenerateColumns="False" CssClass="FontSmall"
                    GridLines="None" Width="690px" OnRowCreated="gvSummary_RowCreated" ShowFooter="True">
                    <Columns>
                        <asp:TemplateField HeaderText="Coverage Group" Visible="False">
                            <FooterStyle BackColor="#F4EDE1" />
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="PerPayCost" HeaderText="Your Per Pay Cost" Visible="False">
                            <HeaderStyle HorizontalAlign="Right" />
                            <ItemStyle HorizontalAlign="Right" />
            ...
            <div class="InputRowTitle" style="width: 690px" id="dvSpecisl" runat="server">
                <asp:GridView ID="gvspecial" runat="server" AutoGenerateColumns="False" CssClass="FontSmall"
                    GridLines="None" Width="690px" ShowFooter="True">
                    <Columns>
