<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SPN.aspx.cs" Inherits="EnrollmentWizardSetup.SPN" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="FullPage">
            <div class="Section">
                <asp:Label ID="lblPageTitle" runat="server" Text="SPN/HSA Page Setup"
            ...
            <div class="Section">
                                        <asp:RadioButtonList ID="rblItem" runat="server" CssClass="FontSmall10" Font-Bold="True"
                                            ...
                                            <asp:ListItem Selected="True" Value="38">Message</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </div>
