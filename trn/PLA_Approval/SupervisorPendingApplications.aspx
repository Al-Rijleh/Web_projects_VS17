...
<%@ Page Language="c#" Codebehind="SupervisorPendingApplications.aspx.cs" AutoEventWireup="false"
    Inherits="PLA_Approval.SupervisorPendingApplications" %>
            ...
            <td valign="top">
                <form id="Form1" method="post" runat="server">
                    <table class="fontsmall" id="Table1" cellspacing="0" cellpadding="0" width="100%"
                            ...
                            <td height="10%">
                                <table class="fontsmall" id="Table2" cellspacing="0" cellpadding="0" width="100%"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblProcessing_Year" runat="server" Font-Bold="True" CssClass="fontsmall"></asp:Label>
                                            <asp:Label ID="lblScript" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="border-bottom: silver thin solid">
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                        ...
                        <tr>
                            <td height="1%">
                                <asp:Label ID="lbl_fldPLASupervisorPendingApproval" runat="server" CssClass="fontsmall"></asp:Label></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:LinkButton ID="lnkbtnSystemAdministrator" runat="server" Visible="False" CssClass="fontsmall">Super User Page</asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                <asp:LinkButton ID="lnkbtnSelectEmployee" runat="server" CssClass="fontsmall" Visible="False">Select Supervisor</asp:LinkButton></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label4" runat="server" CssClass="fontsmall">Show Request Status: </asp:Label>&nbsp;<asp:DropDownList
                                    ID="ddlWhat" runat="server" CssClass="input_control_small" Width="250px">
                                    <asp:ListItem Value="1" Selected="True">Pending Approval</asp:ListItem>
                                    <asp:ListItem Value="6">Request Declined</asp:ListItem>
                                    <asp:ListItem Value="2">Approved - Pending Payment</asp:ListItem>
                                    <asp:ListItem Value="18">Pending Supervisor Evaluation Review</asp:ListItem>
                                    <asp:ListItem Value="1000">All Requests</asp:ListItem>
                                </asp:DropDownList>&nbsp;
                                <asp:LinkButton ID="lnkbtnGo" runat="server" CssClass="fontsmall">Select</asp:LinkButton></td>
                        </tr>
                        <tr>
                            <td height="1%">
                                &nbsp;</td>
                        ...
                        <tr>
                            <td valign="top">
                                <asp:DataGrid ID="dgPending" runat="server" CssClass="fontsmall" Width="795px" AutoGenerateColumns="False">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="duty_hours" HeaderText="Duty&lt;br /&gt;Hours">
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="year_to_hours" 
                                            HeaderText="Year to&lt;br /&gt;Date Hours"></asp:BoundColumn>
                        ...
                        <tr>
                            <td>
                                <asp:HyperLink ID="HyperLink1" runat="server" CssClass="fontsmall" NavigateUrl="/scripts/basweb.exe/view?Module=N"
                                    Visible="False">Home</asp:HyperLink>
