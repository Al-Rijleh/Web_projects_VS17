<%@ Page language="c#" Codebehind="History.aspx.cs" AutoEventWireup="false" Inherits="History.History" %>
									...
									<TABLE id="Table8" cellSpacing="0" cellPadding="0" width="790" border="0">
										<TR>
												...
												<TABLE id="Table6" height="305" cellSpacing="0" cellPadding="0" width="370" border="0">
													<TR>
														<TD style="BORDER-BOTTOM: silver 1px solid">
															<DIV class="fontsmall" style="OVERFLOW: auto; WIDTH: 365px; HEIGHT: 285px; text-align: left"
																align="left" DESIGNTIMEDRAGDROP="827"><asp:datagrid id="dgHistory" runat="server" CssClass="smallsize" GridLines="Horizontal" BorderWidth="1px"
											...
											<TD vAlign="top" align="left" width="400"><asp:panel id="pnlViewer" runat="server" CssClass="fontsmall" Visible="False">
													<TABLE class="smallsize" id="Table4" style="BORDER-RIGHT: silver 1px solid; BORDER-TOP: silver 1px solid; BORDER-LEFT: silver 1px solid; BORDER-BOTTOM: silver 1px solid"
