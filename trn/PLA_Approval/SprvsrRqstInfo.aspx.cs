...
{
	/// <summary>
	/// Summary description for SprvsrRqstInfo.
	/// </summary>
	public class SprvsrRqstInfo : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Label lbl_fld_pla_approval_suppervisor_request_more_information;
...
//			lblPassordError.Text = "";
		...
		private bool DoSave_CDP()
		{
			...
			Oracle.DataAccess.Client.OracleCommand cmd = new Oracle.DataAccess.Client.OracleCommand("basdba.PKG_Training_cdp.req_rqst_info_by_sprvsor",conn);
...
//				throw;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Request.Params["who"] == "payor")
                    lblScript.Text = "<script>alert('Your request for addition information has been saved.');document.location.replace('PayorPendingApprovals.aspx?SkipCheck=YES');</script>";
                else if (Request.Params["who"] == "cdp")
                {
                    ...
                    lblScript.Text = "<script>alert('Your request for addition information has been saved.');opener.window.location.href='" + cdpUrl + "';window.close()</script>";
                }
                else
                    lblScript.Text = "<script>alert('Your request for addition information has been saved.');document.location.replace('SupervisorPendingApplications.aspx?SkipCheck=YES');</script>";
            }
        }
