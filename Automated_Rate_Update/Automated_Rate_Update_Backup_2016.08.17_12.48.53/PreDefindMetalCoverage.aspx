...
<body>
    ...
    <div class="FullPageMenu" runat="server" id="dvSelectReport">
        ...
        <table>
          <tr>
            ...
            <td>
            Check here if you need us to send COBRA continuants open enrollment information about this plan
            </td>
          </tr>
        </table>
    ...
    <div class="FullRowMenu margintop20 " id="Div4" runat="server">
        ...
        <asp:Button ID="btnSave" runat="server" Text="Save" Width="100px" OnClick="btnSave_Click"
            Visible="False" />
        <asp:Button ID="btnUpdate" runat="server" Text="Update" Width="100px" Visible="False" OnClientClick="DoSave()" />
