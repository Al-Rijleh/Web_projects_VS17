...
{
    public partial class cvrg_msg : System.Web.UI.Page
    {
        string session_id = "";
        ...
        {
            DataTable tbl = Data.Get_Cvrg_List(ViewState["Selected_Account_Number"].ToString(), ddlProcessingYear.SelectedValue, ddlClass.SelectedValue);
        ...
        protected void gvGroups_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (tbl == null)
                tbl = Data.Get_Cvrg_List(ViewState["Selected_Account_Number"].ToString(), ddlProcessingYear.SelectedValue, ddlClass.SelectedValue);
            ...
            tbl = Data.CoverageMessage(strid, rblEnrollType.SelectedValue);
        ...
        protected void rblEnrollType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataTable tbl = Data.CoverageMessage(ViewState["record_id"].ToString(), rblEnrollType.SelectedValue);
            lblMessage.Text = tbl.Rows[0]["Message"].ToString();
            reMessage.Content = lblMessage.Text;
            tbl.Dispose();
        }
