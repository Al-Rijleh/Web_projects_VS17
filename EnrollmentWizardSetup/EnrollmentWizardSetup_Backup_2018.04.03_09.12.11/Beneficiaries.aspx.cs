...
namespace EnrollmentWizardSetup
{
    public partial class Beneficiaries : System.Web.UI.Page
    {
        ...
        protected void rblMode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Welcome.ClearRadioButtonList(cblAccounts);
        ...
        protected void btnSaveReuirePage_Click(object sender, EventArgs e)
        {
            Data.SaveBenefitPgRequiredForNewEE(session_id, rblBeneficieryPageRequired.SelectedValue, cblPageSave.SelectedValue);
            string strDone = "<script>alert('Saved Successfully !')</script>";
            Page.ClientScript.RegisterStartupScript(Page.GetType(), "strDone", strDone);
        }

        protected void btnVisivle_Click(object sender, EventArgs e)
        {
            Data.SaveShowBeneficiaries(session_id, rblVisible.SelectedValue, rblPageSave.SelectedValue);
            string strDone = "<script>alert('Saved Successfully !')</script>";
            Page.ClientScript.RegisterStartupScript(Page.GetType(), "strDone", strDone);
        }
        ...
        protected void btnSaveReuirePageAnnualOE_Click(object sender, EventArgs e)
        {
            Data.SaveBenefitPgReqForAnualOE(session_id, rblBeneficieryPageRequiredAnnualOE.SelectedValue, cblPageSaveAnnualOE.SelectedValue);
            string strDone = "<script>alert('Saved Successfully !')</script>";
            Page.ClientScript.RegisterStartupScript(Page.GetType(), "strDone", strDone);
        }
