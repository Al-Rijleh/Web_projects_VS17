<%@ Page language="c#" Codebehind="CancelApplication2.aspx.cs" AutoEventWireup="false" Inherits="PLA_Approval.CancelApplication2" validateRequest=false %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<TABLE class="fontsmall" id="Table1" style="Z-INDEX: 101; LEFT: 5px; POSITION: absolute; TOP: 5px"
				...
				<TR>
					<TD vAlign="top">
						<asp:label id="lbl_fldPla_ApprovalSupervisorDoCancellation" runat="server" CssClass="fontsmall">To finalize your Cancellation of the above captioned training, click <b>
								Save</b>; otherwise, click <b>Cancel</b><br><br></asp:label></TD>
				<TR>
					<TD height="1%">
