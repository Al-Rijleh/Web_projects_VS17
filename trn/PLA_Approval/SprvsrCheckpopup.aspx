<%@ Page language="c#" Codebehind="SprvsrCheckpopup.aspx.cs" AutoEventWireup="false" Inherits="PLA_Approval.SprvsrCheckpopup" %>
...
<HTML>
	<HEAD>
		...
		function IsPopupBlocker() {
			...
			WindowOpen.close();	
			window.location.href="SupervisorPendingApplications.aspx"	
			} 
			catch(e){ 
