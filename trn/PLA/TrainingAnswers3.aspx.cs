...
{
	/// <summary>
	/// Summary description for TrainingAnswers3.
	/// </summary>
	public class TrainingAnswers3 : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
                Bas_Utility.Utilities.SetValidators(Page);
			...
			if (Request.Cookies["Session_ID"] != null)
			{
				string parPtemplate = "<script language='javascript'>" +
					"window.open('/web_projects/ptemplate/header.aspx?pagename=Training Evaluation','Frame_detailing_the_selected_module_and_current_program_page');</script>";
		...
		private void CanAccess()
		{
			...
			if (strResult=="1")
				Response.Redirect("/Web_Projects/trn/PLA/out.aspx?message=Unknown Application"+"&backurl=SelectApp.aspx" ,true);
			else if (strResult=="2")
				Response.Redirect("/Web_Projects/trn/PLA/out.aspx?message=Evaluation already completed"+"&backurl=SelectApp.aspx" ,true);
		}
