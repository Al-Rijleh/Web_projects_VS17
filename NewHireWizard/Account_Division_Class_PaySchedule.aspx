...
<!--
    ...
    function showDialog3grp1() {       
        window.open("/web_projects/account_number/Default.aspx?SkipCheck=YES&goto=/web_projects/NewHireWizard/Account_Division_Class_PaySchedule.aspx?addhis=1", "_self");
        return false;
    }
...
<body>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="txtAccountNameNumberValues">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Panel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="txtClassValue">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Panel1" UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="txtPayScheduleValue">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Panel1" UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="txtHireDate">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="txtHireDate" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="RangeValidator1" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="lblErrorProcessingYear" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="lblError60Days" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="lblHireDateWarning" UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        ...
        <asp:HiddenField ID="hiduserGroup" runat="server" />
        <br />
        ...
        <div id="dvFullPage" runat="server" class="FullPage">
            <asp:Panel ID="Panel1" runat="server" class="FullPage">
                ...
                <div class="InputRow FontSmall">
                    ...
                    <div class="ChangeCommand" style="width: 100px">
                    ...
                    <div class="Validator">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtAccountNameNumberValues"
                            CssClass="FontSmall" Display="Dynamic" ErrorMessage="Required Account"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <%--Class--%>
                <div class="InputRow FontSmall">
                    ...
                    <div class="Validator">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtClassValue"
                            CssClass="FontSmall" Display="Dynamic" ErrorMessage="Required Class Code" Enabled="False"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <%--Pay Schedule--%>
                <div class="InputRow FontSmall" runat="server" visible="false" id="dvPayStatus">
                    ...
                    <div class="Validator">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtPayScheduleValue"
                            CssClass="FontSmall" Display="Dynamic" ErrorMessage="Required Pay Schedule" Enabled="False"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div id="dvAllDataFields" class="FullPage FontSmall" runat="server" visible="true">
                    ...
                    <div class="InputRow FontSmall">
                        ...
                        <div class="InputValidator">
                            ...
                            <asp:Label ID="lblHireDateWarning" runat="server" ForeColor="Maroon"></asp:Label>
                        </div>
                        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtDateofBirth"
                            ...
                            Type="Date" Operator="GreaterThan" Display="Dynamic" Enabled="False"></asp:CompareValidator>
                    </div>
                    <%--Salary--%>
                    <div class="InputRow FontSmall">
                        <div class="InputLabel">
                        ...
                        <div id="dvSalary" runat="server" class="InputValue">
                        ...
                        <div class="InputValidator">
                            ...
                            <asp:RangeValidator ID="RangeValidator2" runat="server" Display="Dynamic" ControlToValidate="txtSalary"
                                ErrorMessage="Incorrect Salary" Type="Double" MinimumValue="0" MaximumValue="10000000"></asp:RangeValidator>
                        </div>
                    </div>
                    <%--Job Title--%>
                    <div class="InputRow FontSmall">
                        <div class="InputLabel">
                            ...
                            <div class="InputLabel" style="width: 125px">
                                ...
                                <asp:Label ID="req3" runat="server" AssociatedControlID="txtJobTitle" Text="*" ForeColor="White"></asp:Label>
                            </div>
                        </div>
                        <div class="InputValue">
                        ...
                        <div class="InputValidator">
                            <div class="InputValidator">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" Display="Dynamic"
                                    ...
                                    Visible="False" EnableClientScript="False" EnableTheming="True"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>
                    <%--Company ID--%>
                        ...
                        <div class="InputValidator">
                            <div class="InputValidator">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" Display="Dynamic"
                                    ...
                                    InitialValue="x" Enabled="False"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>
                    <%--FTE_HRS--%>
                            ...
                            <div class="InputValidator">
                                <div class="InputValidator">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" Display="Dynamic"
                                        ControlToValidate="txtFullHors" ErrorMessage="Required Full Hours" Enabled="False"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="InputRowNoPadding">
