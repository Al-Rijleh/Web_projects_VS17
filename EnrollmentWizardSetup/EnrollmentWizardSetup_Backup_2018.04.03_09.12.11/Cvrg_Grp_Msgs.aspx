<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Cvrg_Grp_Msgs.aspx.cs"
    Inherits="EnrollmentWizardSetup.Cvrg_Grp_Msgs" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="FullPage">
            <div class="Section">
                <asp:Label ID="lblPageTitle" runat="server" Text="Coverage Grouping Messsages & Instructions"
            ...
            <div class="SectionNoTop">             
                <div class="leftGrid">
                <asp:Label ID="lblPreviuosSetup" runat="server" Text="Existing Groups for [py] Plan Year"
